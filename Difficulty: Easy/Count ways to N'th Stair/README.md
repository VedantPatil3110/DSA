<h2><a href="https://www.geeksforgeeks.org/problems/count-ways-to-nth-stairorder-does-not-matter1322/1?page=1&category=Dynamic%20Programming&difficulty=Easy&sortBy=accuracy">Count ways to N'th Stair</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><table style="border-collapse: collapse; width: 100.013%;" border="1">
<tbody>
<tr>
